...
public class XCS {
    ...
    private boolean doesSubsume(Classifier parent, Classifier child) {
        if (parent.getActionSetSize() == child.getActionSetSize() && parent.getActionId() == child.getActionId()){
            if(couldSubsume(parent)){
                if(isMoreGeneral(parent, child)) {
                    return true;
                }
            }
        }
    ...
    private boolean isMoreGeneral(Classifier parent, Classifier child) {
        ...
        boolean result = (compareInterval(parentCondition.getUnitHitPointsInterval(),childCondition.getUnitHitPointsInterval()) &&
                (compareInterval(parentCondition.getUnitPosXInterval(), childCondition.getUnitPosXInterval()) &&
                compareInterval(parentCondition.getUnitPosYInterval(), childCondition.getUnitPosYInterval()) &&
                compareInterval(parentCondition.getUnitGroundCooldownInterval(),childCondition.getUnitGroundCooldownInterval()) &&
                compareInterval(parentCondition.getNumberAlliesOnMapInterval(),childCondition.getNumberAlliesOnMapInterval()) &&
                compareInterval(parentCondition.getNumberEnemiesOnMapInterval(),childCondition.getNumberEnemiesOnMapInterval()) &&
                compareInterval(parentCondition.getNumberSightedEnemiesOnMapInterval(),childCondition.getNumberSightedEnemiesOnMapInterval()) &&
                compareInterval(parentCondition.getKillCountEnemiesInterval(),childCondition.getKillCountEnemiesInterval()) &&
                compareInterval(parentCondition.getCountAlliesInterval(),childCondition.getCountAlliesInterval()));
    ...
    public boolean matchCondition(Condition parent, Condition child){
        ...
        boolean result = (matchConditionVariable(parentSituation.getUnitHitpoints(), parent.getUnitHitPointsInterval(),childSituation.getUnitHitpoints(), child.getUnitHitPointsInterval()) &&
                ...
                matchConditionVariable(parentSituation.getKillCountAllies(),parent.getCountAlliesInterval(),childSituation.getKillCountAllies(),child.getKillCountAlliesInterval())
